...
public class SecondStageConvection : MonoBehaviour {
    ...
    void Start()
    {
        ...
        clusterSize = 3;
        batchSize = 3;      //Make sure this is equal to clusterSize
        ...
        //for batches
        batchPosition = new Vector3[255, 255];
        batchVorticity = new Vector3[255, 255];
